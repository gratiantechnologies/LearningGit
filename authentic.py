...
if False:
    file_in = EDFReader()
    file_in.open("C:/Users/User/Downloads/1705099T-A.EEG")
...
if False:
    file_in = EDFReader()
    file_in.open('C:/Users/User/Downloads/Test_generator.edf')

    file_out = EDFWriter()
    file_out.open('C:/Users/User/Downloads/Test_generator.edf')
